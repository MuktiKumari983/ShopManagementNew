<?php
echo "Test: quotations.php is loading"; exit;
...
<head>
    <meta charset="UTF-8">
    <title>Quotations - Geeta Enterprises</title>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-2 p-0 sidebar">
                ...
                <a href="quotations.php" class="active"><i class="bi bi-file-text me-2"></i>Quotations</a>
            ...
            <div class="col-md-10 p-4">
                <div class="d-flex justify-content-between">
                    <h2>Quotations</h2>
                    <a href="create_quotation.php" class="btn btn-primary">+ Create New Quotation</a>
                </div>
                <table class="table table-bordered mt-3">
                    ...
                    <tbody>
                        <?php
                        $quotations = $conn->query("SELECT q.*, c.name as customer_name FROM quotations q LEFT JOIN customers c ON q.customer_id = c.id ORDER BY q.id DESC");
                        if (!$quotations) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="convert_to_bill.php?quote_id=<?php echo $q['id']; ?>" class="btn btn-sm btn-success" onclick="return confirm('Convert to bill?')">Convert to Bill</a>
                                <?php else: ?>
